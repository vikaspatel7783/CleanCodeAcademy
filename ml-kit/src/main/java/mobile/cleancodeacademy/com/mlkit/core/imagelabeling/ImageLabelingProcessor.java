...
package mobile.cleancodeacademy.com.mlkit.core.imagelabeling;
...
public class ImageLabelingProcessor extends VisionProcessorBase<List<FirebaseVisionLabel>> {
  ...
  public ImageLabelingProcessor(FirebaseVisionLabelDetectorOptions options) {
  ...
  @Override
  protected void onResultSuccess(List<FirebaseVisionLabel> results) {
