...
package mobile.cleancodeacademy.com.mlkit.core.barcodescanning;
...
public class BarcodeScanningProcessor extends VisionProcessorBase<List<FirebaseVisionBarcode>> {
    ...
    public BarcodeScanningProcessor(ObjectResultCallback objectResultCallback) {
        this();
    ...
    @Override
    protected void onResultSuccess(List<FirebaseVisionBarcode> results) {
        if (null != mObjectResultCallback) {
            mObjectResultCallback.barcodeDetectionResult(results);
        }
    }
